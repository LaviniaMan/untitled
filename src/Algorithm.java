public class Algorithm {
    ...
    String tari[] = {"Anglia", "Romania", "Albania", "SUA", "Franta","Afghanistam","Elvetia", "China"};
        ...
        //Homework
        //Afisati tarile doar cu litera a
        for (String t: tari){
       //     if (t.startsWith("A"))
       //     if (t.charAt(0)=='A')
                if (t.charAt(0)=='A'){
        ...
        //afisare tari ce contin doar litera n
        for (String t:tari){
            if (t.contains("n")){
                System.out.println(t);
            }
        }
        //Afisati tara cu cel mai lung nume
        int max = 0;
        int min = tari[0].length();
        String taraCuLungimeMaxima = "";
        String taraCuLungimeMinima = "";
        System.out.println("Ex 8 si 9 - Algoritmi");
        for (String t:tari){
           // System.out.println(t);
           // System.out.println(t.length());
